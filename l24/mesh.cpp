    ...
    for (unsigned int i = 0; i < pScene->mNumMaterials; i++) {
        ...
        if (pMaterial->GetTextureCount(aiTextureType_DIFFUSE) > 0) {
            ...
            if (pMaterial->GetTexture(aiTextureType_DIFFUSE, 0, &Path,
                ...
                //m_Textures[i] = new Texture(GL_TEXTURE_2D, "C:/Users/suisideboy/source/repos/gluttest/Content/test.png");
                //m_Textures[i] = new Texture(GL_TEXTURE_2D, FullPath.c_str());
                m_Textures[i] = new Texture(GL_TEXTURE_2D, "Content/phoenix.jpg");
