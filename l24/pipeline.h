...
public:
    ...
    void SetPerspectiveProj(PersProjInfo m_persProjInfo){
        m_persProj.FOV = m_persProjInfo.FOV;
        m_persProj.Width = m_persProjInfo.Width;
        m_persProj.Height = m_persProjInfo.Height;
        m_persProj.zNear = m_persProjInfo.zNear;
        m_persProj.zFar = m_persProjInfo.zFar;
    }
...
private:
    ...
    void InitPersProjTransform(mat4& m);
