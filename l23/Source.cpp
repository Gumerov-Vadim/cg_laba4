...
public:
    ...
    Main()
    {
        ...
        m_spotLight.Color = vec3(1.0f, 1.0f, 1.0f);
        m_spotLight.Attenuation.Linear = 0.01f;
        m_spotLight.Position = vec3(-20.0, 20.0, 5.0f);
        m_spotLight.Direction = vec3(1.0f, -1.0f, 0.0f);
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Users/suisideboy/source/repos/gluttest/Content/quad.obj")) {
            return false;
        }

        m_pMesh = new Mesh();

        return m_pMesh->LoadMesh("C:/Users/suisideboy/source/repos/gluttest/Content/phoenix_ugv.md2");
    }
    ...
    virtual void ShadowMapPass()
    {
        ...
        p.SetCamera(m_spotLight.Position, m_spotLight.Direction, vec3(0.0f, 1.0f, 0.0f));
